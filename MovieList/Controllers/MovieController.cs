...
namespace MovieList.Controllers
{
    public class MovieController : Controller
    {
        ...
        {
            ViewBag.Action = "Edit";
            ViewBag.Genres = context.Genres.OrderBy(g => g.Name).ToList(); var movie = context.Movies.Find(id); 
            return View(movie);
        }
        ...
        public IActionResult Edit(Movie movie)
        {
            ...
            {
                ViewBag.Action = (movie.MovieId == 0) ? "Add" : "Edit"; ViewBag.Genres = context.Genres.OrderBy(g => g.Name).ToList(); 
                return View(movie);
            }
        }
